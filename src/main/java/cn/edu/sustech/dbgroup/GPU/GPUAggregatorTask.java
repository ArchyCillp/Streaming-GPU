...
public class GPUAggregatorTask {
    public static GPUNativeLib gpuLib = new GPUNativeLib();
    public static void Main(SingleOutputStreamOperator<Long> stream) {
        stream
                .windowAll(GlobalWindows.create())
                .trigger(PurgingTrigger.of(CountTrigger.of(DataGenerator.windowSize)))
                .process(new GPUComplexArraySumProcessWindowFunction())
                .print();
